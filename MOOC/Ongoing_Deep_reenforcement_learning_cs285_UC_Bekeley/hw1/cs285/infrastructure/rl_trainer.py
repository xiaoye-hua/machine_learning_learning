...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        ## TODO initialize all of the TF variables (that were created by agent, etc.) --> FINISHED
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        for itr in range(n_iter):
            ...
            ) ## TODO implement this function below --> FINISHED
            paths, envsteps_this_batch, train_video_paths = training_returns
            self.total_envsteps += envsteps_this_batch

            # relabel the collected obs with actions from a provided expert policy
            if relabel_with_expert and itr>=start_relabel_with_expert:
                paths = self.do_relabel_with_expert(expert_policy, paths) ## TODO implement this function below --> FINISHED

            # add collected data to replay buffer
            self.agent.add_to_replay_buffer(paths)

            # train agent (using sampled data from replay buffer)
            self.train_agent() ## TODO implement this function below --> FINIDHED
    ...
    def collect_training_trajectories(self, itr, load_initial_expertdata, collect_policy, batch_size):
        ...
        # TODO collect data to be used for training --> FINSHED
        ...
        if self.log_video:
            ...
            ## TODO look in utils and implement sample_n_trajectories --> FINISHED
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            # TODO sample some data from the data buffer --> FNISHED
            ...
            # TODO use the sampled data for training --> FINISHED
    ...
    def do_relabel_with_expert(self, expert_policy, paths):
        ...
        # TODO relabel collected obsevations (from our policy) with labels from an expert policy --> FINISHED
        # HINT: query the policy (using the get_action function) with paths[i]["observation"]
        # and replace paths[i]["action"] with these expert labels
        for p in paths:
            a = expert_policy.get_action(obs=p["observation"])
            p["action"] = a
