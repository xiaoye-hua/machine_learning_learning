...
model_setting_dict = {
    "albert" : [
                ...
                AlbertTokenizer,
                TFAlbertForSequenceClassification,
                "../../pretrained_models/nlp/albert_base"
    ],
    "bert": [
        BertConfig,
        BertTokenizer,
...
# config = model_setting_dict[model_type][0].from_pretrained(
#                                         model_index,
#     #                                     cache_dir=model_setting_dict[model_type][3],
#     # pretrained_model_name_or_path="../../pretrained_models/uncased_L-12_H-768_A-12/bert_config.json",
...
tokenizer = BertTokenizer.from_pretrained(model_setting_dict[model_type][3])
model = TFBertForSequenceClassification.from_pretrained(
"../../pretrained_models/nlp/uncased_L-12_H-768_A-12/bert_model.ckpt.index"
    # model_setting_dict[model_type][3]
    ,from_pt=False, config=config)
